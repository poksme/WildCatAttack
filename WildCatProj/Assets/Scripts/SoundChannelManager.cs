...
public class SoundChannelManager
{
	...
	public void PlayClipAtPoint(AudioClip clip, Transform point) {
		PlayClipAtPoint(clip, point, 1f);
	}

	public void PlayClipAtPoint(AudioClip clip, Transform point, float volume) {
		for (int i = 0; i < channelNbr; i++) {
